...
\newcommand{\institucion}[1]{
  \def\institucionVal{
    \textbf{\fontsize{20}{0}\selectfont #1}\\[0mm]
  }
}
...
\newcommand{\facultad}[1]{
  \def\facultadVal{
    \textbf{\fontsize{16}{0}\selectfont #1}\\[0mm]
  }
}
