...
\newcommand{\makeCover}{
  ...
  \ifpdf
    \pdfbookmark{P\'agina de Título}{titulo}
  \fi
  ...
  % maneras bastante inverosímiles. Adem\'as, _s\'olo_ pueden cambiarse en
  ...
  % cortas. Pero bueno, si aun así quieres cambiar los m\'argenes _a nivel
  % global_ es preferible que uses el paquete geometry, cuya inclusi\'on
  % recibe los centímetros de m\'argen que quieres en cada lado, y \'el se
  ...
  % Si te falla aquí, incluye el paquete calc en el pre\'ambulo.
