...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\imagenPortada{Imagenes/Vectorial/umsa-logo.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tipoDocumento{PROYECTO DE GRADO}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\institucion{%
    \large{UNIVERSIDAD MAYOR DE SAN ANDRÉS} \\[1mm]
    \normalsize{FACULTAD DE INGENIERÍA}\\[1mm]
    \normalsize{INGENIERÍA QUÍMICA AMBIENTAL ALIMENTOS Y PETROQUÍMICA}\\[5mm]%
}
