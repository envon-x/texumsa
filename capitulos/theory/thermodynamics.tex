...
\subsection{ECUACIÓN VIRIAL GENERAL}
    ...
    La ecuación virial puede ser apreciada como una serie de Maclaurin\footnotetext{También llamado serie de Taylor}, donde ${\P{}}/{\R{} \T{}}$; en vista de su naturaleza polinomial, puede escribirse como serie de potencias de $1/\Vm$, el cual se muestra a continuación:
